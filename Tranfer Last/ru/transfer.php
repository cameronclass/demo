...
require_once('components/header.php'); ?> <main class="container-fluid">
  ...
  <section class="container-fluid reservation">
    <div class="container">
      <h1>Указанные цены не с каждого человека а Для Машины.</h1>
      <div class="row ml-lg-0 ml-md-0">
        <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-lg-0 pl-md-0 mb-4">
          ...
          <div class="card mt-4 transfer-hemen">
            <h3 class="card-header">Напишите нам или Позвоните</h3>
            <div class="card-body d-flex align-items-center justify-content-between flex-column">
              ...
              <p class="card-text">Можете связаться с нами в любое время</p>
            ...
            <div class="card card-cars">
              ...
              <div class="card-body row p-1">
                ...
                <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-around flex-column">
                  <h5 class="card-content-text">Подходит для трансфера до 6 ти человек.</h5>
                  <div class="d-flex d-flex justify-content-around">
                    <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: До 6ти человек.">
                      <ion-icon name="snow-outline" style="font-size: 25px;"></ion-icon>
                    </button>
                    <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: Бесплатный WİFİ">
                      <ion-icon name="wifi-outline" style="font-size: 25px;"></ion-icon>
                    </button>
                    <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: До 7 багажов">
                      <ion-icon name="briefcase-outline" style="font-size: 25px;"></ion-icon>
                    </button>
                    <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: Бесплатные закуски">
                ...
                <div class="col-lg-3 col-md-3 col-12 d-flex justify-content-center flex-column text-center">
                  ...
                  <h3 class="text-uppercase">Цена трансфера</h3> <?php if(isset($_SESSION['back_on'])){?> <h4 class="text-uppercase m-1 old-price"><?= $doublePriceWithoutDiscount?></h4>
                  ...
                  <h4 class="text-uppercase m-1 new-price" name="sale"><?= $priceDiscount?></h4> <?php }?> <button type="submit" class="btn btn-success mx-2">Выбрать машину</button>
                </div>
              </div>
            </div>
          </form>
