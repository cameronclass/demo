   ...
   <!-- Steps Start -->
    ...
    <section class="container-fluid reservation">
        ...
        <div class="container">
            ...
            <h1>Rezervasyonunuz için sunulan fiyatlarımız kişi başı değil, araç başı fiyatlardır.</h1>
                        ...
                        <table class="table bg-white">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">Transfer Tarihi</th>

                                    <?php if (isset($_SESSION['date_to'])) {?>

                                    <td><?=$_SESSION['date_to']?></td>
                                ...
                                <tr>
                                    ...
                                    <th scope="row">Saati</th>

                                    <?php if (isset($_SESSION['time_to'])) {?>

                                    <td><?=$_SESSION['time_to']?></td>
                                ...
                                <?php if(isset($_SESSION['back_on'])){
                                  ...
                                  <tr>
                                    ...
                                    <?php if (isset($_SESSION['back_date'])) {?>

                                    <td><?=$_SESSION['back_date']?></td>
                                 ...
                                 <tr>
                                    ...
                                    <?php if (isset($_SESSION['back_time'])) {?>

                                    <td><?=$_SESSION['back_time']?></td>
                                  ...
                                  <h5 class="card-header font-weight-bold h4"><?php echo $_SESSION['name_auto']?></h5>
                                    ...
                                    <div class="card-body row p-1">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-around flex-column">
                                            ...
                                            <h5 class="card-content-text">6 kişiye kadar transferleriniz için uygundur.</h5>

                                            <div class="d-flex d-flex justify-content-around">

                                                <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: 6 kişi kapasiteye sahiptir.">

                                                    <ion-icon name="snow-outline" style="font-size: 25px;"></ion-icon>

                                                </button>

                                                <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: Ücretsiz WİFİ">

                                                    <ion-icon name="wifi-outline" style="font-size: 25px;"></ion-icon>

                                                </button>

                                                <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: 7 adet bagaj">

                                                    <ion-icon name="briefcase-outline" style="font-size: 25px;"></ion-icon>

                                                </button>

                                                <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: Araç ikramları">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-12 d-flex justify-content-center flex-column text-center">
                                            ...
                                            <h3 class="text-uppercase">Araç Fiyatı</h3>

                                            <?php if(isset($_SESSION['back_on'])){?>

                                            <h4 class="text-uppercase m-1 old-price"><?= $doublePriceWithoutDiscount?></h4>

                                            <h4 class="text-uppercase m-1 new-price"><?= $doublePriceDiscount ?></h4>

                                            <?php } else{?>

                                            <h4 class="text-uppercase m-1 old-price"><?= $priceWithoutDiscount?></h4>

                                            <h4 class="text-uppercase m-1 new-price" name ="sale"><?= $priceDiscount?></h4>

                                            <?php }?>



                                             <button type="submit" class="btn btn-success mx-2">Aracı Seç</button>
                                    ...
                                    <div class="card-body row p-1">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-around flex-column">
                                            ...
                                            <div class="d-flex d-flex justify-content-around">
                                                ...
                                                <button class="btn btn-primary d-flex align-items-center mr-2" uk-tooltip="title: İklim kontrolu">
