      ...
      <div class="row">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 mb-4 form-information">
          <form action="app/mail.php" method="POST">
            <h3 class="text-center">Passengers Insformation</h3>
            ...
            <h3 class="text-center">Transfer Informations</h3>
            <div class="form-group d-flex flex-wrap justify-content-between">
              <div class="w-40">
                <label class="w-100" for="name">Time :</label>
                <input type="text" class="timepicker form-control w-100" value="<?php echo $_SESSION['time_to']?>" id="name" name="time" required>
              </div>
              <div class="w-40">
                <label class="w-100" for="name">Air Company :</label>
                <input type="text" name="air_company" class="form-control w-100" id="name">
              </div>
              <div class="w-40">
                <label class="w-100" for="name">Flight number* :</label>
                <input type="text" name="flight_number" class="form-control w-100" id="name">
              </div>
            </div>
            <div class="form-group">
              <label for="exampleFormControlTextarea1">Address Destionation (Hotel, Shopping center, Area, Street...) :</label>
            ...
            <h3 class="text-center">Special request</h3>
            <div class="d-flex justify-content-between">
              <label for="bebek">Child seat (one child seat is provided free of charge , <br> for each subsequent child seat 3$)</label>
            ...
            <h2 class="card-header">Transfer Info</h2>
             ...
             <img src="<?php echo $_SESSION['white_auto']?>" alt="">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">Time</th> <?php if (isset($_SESSION['time_to'])) {?> <td><?=$_SESSION['time_to']?></td> <?php }?>
                </tr>
                <tr>
